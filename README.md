...
Summary
-------
Hardware abstraction modules based on libhybris

Description
-----------
This are several modules based on nyx-lib which abstract several hardware components
behind the nyx API based on libhybris.
